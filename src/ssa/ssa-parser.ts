...
const FORMAT_START_RE = /*#__PURE__*/ /^Format:[\s\t]*/,
  ...
  COMMENT_START_RE = /*#__PURE__*/ /^Comment:/,
  FONT_NAME_RE = /*#__PURE__*/ /^fontname:[\s\t]*(.+)$/i,
  FORMAT_SPLIT_RE = /*#__PURE__*/ /[\s\t]*,[\s\t]*/,
  SECTION_RE = /*#__PURE__*/ /^\[(.*)\]$/,
  SCRIPT_INFO_SECTION_RE = /*#__PURE__*/ /^\[Script Info\]$/i,
  STYLES_SECTION_RE = /*#__PURE__*/ /^\[.*Styles\]$/i,
  EVENTS_SECTION_RE = /*#__PURE__*/ /^\[.*Events\]$/i,
  FONTS_SECTION_RE = /*#__PURE__*/ /^\[Fonts\]$/i,
  OVERRIDE_BLOCK_RE = /*#__PURE__*/ /\{([^}]*)\}/g,
  OVERRIDE_TAG_RE = /*#__PURE__*/ /\\([a-zA-Z]+)([^\\]*)/g,
  COLOR_TAG_RE = /*#__PURE__*/ /&H([0-9a-fA-F]{2,8})&?/,
  NEW_LINE_RE = /*#__PURE__*/ /\\N/g,
  SOFT_LINE_RE = /*#__PURE__*/ /\\n/g,
  HARD_SPACE_RE = /*#__PURE__*/ /\\h/g,
  KEY_VALUE_RE = /*#__PURE__*/ /^([^:]+):[\s\t]*(.*)$/,
  ANGLE_BRACKET_RE = /*#__PURE__*/ /[<>]/g;
