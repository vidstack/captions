...
Status: exploration, September 2026. `media-captions/canvas` ships as an experimental writer.
This note records what the canvas work showed about the renderer architecture and the parser to
renderer contract, and proposes where the style model should go.
